  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="inventeries.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Accounting</li></a>
...
else  // display all items
{
 ...
 ?>
  ...
  <div class="content">
   <ol class="breadcrumb ">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Navigation</a></li>
