...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div class="item">
      <ul class="nostyle zero">
          <a href="sitesetting.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Application settings</li></a>
          ...
          <a href="logout.php"><li><i class="fa fa-circle-o fa-fw"></i> Log out</li></a>
      </ul>
    </div>
</div>
...
<div class="account" style="display: none;">
  <div style="background: #3C8DBC;padding: 22px;" class="center">
    ...
    <span style="color: #CEE6F0;font-size: 10pt">User from:<?php echo $user['date']; ?></span>
  </div>
...
<ol class="breadcrumb ">
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <h4>Application settings</h4><hr>
      <form method="POST">
         <div class="form-group">
            <label for="some" class="col-form-label">Application name</label>
            <input type="text" name="title" class="form-control" value="<?php echo siteTitle() ?>" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Website name</label>
